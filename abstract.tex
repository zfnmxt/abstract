...
parallel programs is presented. The approach uses a recomputation-based approach
...
perfectly nested scopes do not introduce recomputation. This is exploited by
